      ...
      <Grid container direction='row' spacing={md ? 0 : 4} rowSpacing={md ? 2 : 0}>
        ...
        <Grid item xs={12} md={6}>
          <Box p={md ? 2 : 4} sx={{ position: 'relative', height: md ? 280 : 350, border: '2px solid black', borderRadius: '5px', '&:hover': { backgroundColor: '#71eeb8' } }}>
            ...
            <div style={{ position: 'absolute', bottom: 0 }}>
              <Typography variant='h1' pb={4} fontWeight='bold' sx={{ fontSize: '1rem' }}>Tech: MongoDB, ExpressJs, ReactJs, NodeJs, Material UI</Typography>
            </div>
          </Box>
        </Grid>
        <Grid item xs={12} md={6}>
          <Box p={md ? 2 : 4} sx={{ position: 'relative', height: md ? 280 : 350, border: '2px solid black', borderRadius: '5px', '&:hover': { backgroundColor: '#71eeb8' } }}>
            ...
            <div style={{ position: 'absolute', bottom: 0 }}>
              <Typography variant='h1' pb={4} fontWeight='bold' sx={{ fontSize: '1rem' }}>Tech: ReactJs, Material UI</Typography>
            </div>
          </Box>
        </Grid>
        <Grid item xs={12} md={6}>
        ...
        <Grid item xs={12} md={6}>
          <Box p={md ? 2 : 4} sx={{ position: 'relative', height: md ? 280 : 350, border: '2px solid black', borderRadius: '5px', '&:hover': { backgroundColor: '#71eeb8' } }}>
            ...
            <div style={{ position: 'absolute', bottom: 0 }}>
              <Typography variant='h1' pb={4} fontWeight='bold' sx={{ fontSize: '1rem' }}>Tech: NextJs, Material UI</Typography>
            </div>
          </Box>
        </Grid>
      </Grid>  
