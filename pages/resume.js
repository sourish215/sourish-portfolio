    ...
    <>
      ...
      >
        ...
        <Typography variant={md ? 'h6' : 'h5'} fontWeight='bold'>
          Download my resume <Link href='https://drive.google.com/file/d/1nb6ay6PDi3GaOSiCQSUFq1PLf-srUoDS/view?usp=sharing' sx={{ color: 'inherit', '&: hover': {color: '#71eeb8'} }}>here</Link>.
        </Typography>
